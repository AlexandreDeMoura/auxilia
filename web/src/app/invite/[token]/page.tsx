...
export default function InviteAcceptPage({
				...
				<CardHeader className="text-center flex flex-col items-center">
					<CardTitle className="text-2xl flex flex-col items-center justify-center">
						<Image
							...
							className="mb-2"
						/>
						<span className="text-2xl">Invalid invite</span>
					</CardTitle>
				</CardHeader>
				<CardContent>
					<p className="text-sm text-muted-foreground text-center">
						This invite link is invalid or has expired. Please ask your workspace admin for a new invite.
					</p>
				</CardContent>
				<CardFooter>
					<Button
	...
	return (
		<Card className="w-full max-w-md">
						...
						{inviteInfo.googleEnabled && (
							<>
								...
								<Button
									...
									className="w-full cursor-pointer"
									onClick={() => {
										window.location.href = `/api/backend/auth/google?invite_token=${token}`;
									}}
								>
									<svg
			...
			{!inviteInfo?.passwordEnabled && inviteInfo?.googleEnabled && (
				<CardFooter>
					<Button
						type="button"
						variant="outline"
